  ...
  return (
    <>
      ...
      <div
        ...
        className="w-[30vw] h-[30vh] flex justify-center flex-col items-center"
      >
        <label className="bg-blue-500 text-center rounded-sm h-[5vh] w-[20vw] text-white p-2 cursor-pointer" htmlFor="file_input">
        Choose file or Drag and drop
        <input onChange={fileOnChange} id="file_input" type="file" className="hidden" />
      </label>
        <span className="font-bold text-lg text-blue-400">{droppedFile}</span>
      </div>
